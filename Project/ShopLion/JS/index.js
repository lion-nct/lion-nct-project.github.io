...
products.forEach((e) => {
  ...
  <div class="product-card">
      <img src="./Project/ShopLion/images/saleoff.png" class="sale-img"></img>
...
(function ($) {
  ...
  $(".switch").on("click", function () {
    if ($("body").hasClass("light")) {
      ...
      // $(".container_boss div").removeClass(".container_header-left");
    } else {
      $("body").addClass("light");
      $(".switch").addClass("switched");
      // $(".container_boss div:nth-child(1)").addClass("container_header-left-2");
    }
  });
  // $(".switch").on("click", function () {
